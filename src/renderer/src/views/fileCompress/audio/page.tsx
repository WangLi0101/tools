...
import { Download, FileAudio, Music, Settings2, Play, Loader2, XCircle, Save } from 'lucide-react'
        ...
        <Card className="overflow-hidden transition-all hover:shadow-md">
          ...
          <CardContent className="space-y-6 pt-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-muted-foreground">比特率</label>
            ...
            <div className="space-y-3">
              ...
              {file ? (
                ...
                <div className="h-32 rounded-lg border border-dashed border-muted-foreground/25 bg-muted/50 flex flex-col items-center justify-center gap-2 text-muted-foreground">
                  <FileAudio className="size-8 opacity-50" />
